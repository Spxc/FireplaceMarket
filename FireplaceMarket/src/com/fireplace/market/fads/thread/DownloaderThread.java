package com.fireplace.market.fads.thread;
...
public class DownloaderThread extends Thread
{
        ...
        // instance variables
        private DetailedAppsController parentActivity;
         ...
         */
        public DownloaderThread(DetailedAppsController inParentActivity, String inUrl)
        {
                downloadUrl = "";
                if(inUrl != null)
                {
         ...
         * DetailedAppsController activity of changes in state. Writes the file to
        ...
        public void run()
        {
                ...
                msg = Message.obtain(parentActivity.activityHandler,
                		DetailedAppsController.MESSAGE_CONNECTING_STARTED,
                                0, 0, downloadUrl);
                ...
                try
                {
                        ...
                        msg = Message.obtain(parentActivity.activityHandler,
                        		DetailedAppsController.MESSAGE_DOWNLOAD_STARTED,
                                        fileSizeInKB, 0, fileName);
                        parentActivity.activityHandler.sendMessage(msg);
                        
                        // start download
                        inStream = new BufferedInputStream(conn.getInputStream());
                        outFile = new File(Environment.getExternalStorageDirectory() + "/com.fireplace.market.fads/" + fileName);
                        ...
                        while(!isInterrupted() && (bytesRead = inStream.read(data, 0, data.length)) >= 0)
                        {
                                ...
                                msg = Message.obtain(parentActivity.activityHandler,
                                		DetailedAppsController.MESSAGE_UPDATE_PROGRESS_BAR,
                                                totalReadInKB, 0);
                                parentActivity.activityHandler.sendMessage(msg);
                        }
                        ...
                        else
                        {
                                // notify completion
                                msg = Message.obtain(parentActivity.activityHandler,
                                		DetailedAppsController.MESSAGE_DOWNLOAD_COMPLETE);
                                parentActivity.activityHandler.sendMessage(msg);
                ...
                catch(MalformedURLException e)
                {
                        ...
                        msg = Message.obtain(parentActivity.activityHandler,
                        		DetailedAppsController.MESSAGE_ENCOUNTERED_ERROR,
                                        0, 0, errMsg);
                        parentActivity.activityHandler.sendMessage(msg);
                }
