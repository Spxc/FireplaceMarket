...
public class StorageActivity extends FireplaceController {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		adapter = new ArrayAdapter<String>(this, R.layout.list_item, R.id.app_name, products);
		...
		inputSearch.addTextChangedListener(new TextWatcher() {
		    ...
		    public void onTextChanged(CharSequence cs, int arg1, int arg2, int arg3) {
		        ...
		        StorageActivity.this.adapter.getFilter().filter(cs);
		    }
