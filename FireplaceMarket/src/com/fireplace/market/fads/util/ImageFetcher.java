...
public class ImageFetcher extends ImageResizer {
	...
	private void checkConnection(Context context) {
		...
		if (networkInfo == null || !networkInfo.isConnectedOrConnecting()) {
			...
			Toast.makeText(context, R.string.no_network_error,
	 ...
	 */
	private Bitmap processBitmap(String data, Boolean local) {
		if (FireplaceApplication.DEBUG) {
	...
	protected Bitmap processBitmap(Object data) {
		return processBitmap(String.valueOf(data), false);
	}

	@Override
	protected Bitmap processBitmap(Object data, Boolean local) {
		return super.processBitmap(String.valueOf(data), local);
	}
