 ...
 * </p>
 */
public abstract class JbAsyncTask<Params, Progress, Result> {
	 ...
	 */
	public static final Executor SERIAL_EXECUTOR = Fireplace.IS_HONEYCOMB ? new SerialExecutor()
	 ...
	 *             {@link JbAsyncTask.Status#RUNNING} or
	 *             {@link JbAsyncTask.Status#FINISHED}.
	 * 
	 * @see #executeOnExecutor(java.util.concurrent.Executor, Object[])
	 * @see #execute(Runnable)
	 */
	public final JbAsyncTask<Params, Progress, Result> execute(Params... params) {
	 ...
	 * @see #execute(Object[])
	 */
	public final JbAsyncTask<Params, Progress, Result> executeOnExecutor(
	...
	private static class AsyncTaskResult<Data> {
		final JbAsyncTask mTask;
		final Data[] mData;

		AsyncTaskResult(JbAsyncTask task, Data... data) {
			mTask = task;
			mData = data;
		}
	}
